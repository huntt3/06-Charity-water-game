...
// Water can (goal)
const waterCanObj = new WaterCan(340, 200, 40, 40, world, Matter);
...
// Ramps
const rampLeft = new Ramp(60, 250, 100, 16, Math.PI / 10, '#BBDEB2', world, Matter);
const rampRight = new Ramp(340, 250, 100, 16, -Math.PI / 10, '#BBDEB2', world, Matter);
