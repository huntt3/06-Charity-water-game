// level6.js - Procedurally generated pinball level
...
// Water can (goal)
const waterCanObj = new WaterCan(200, 60, 40, 40, world, Matter);
const waterCan = waterCanObj.body;

// Plunger in bottom center
const plunger = new Plunger(200, 370, 16, 48, world, Matter, ball);
...
// Bumpers
const bumper1 = new Bumper(100, 200, 16, world, Matter);
bumper1.body.restitution = 1.2;
const bumper2 = new Bumper(200, 150, 16, world, Matter);
bumper2.body.restitution = 1.2;
const bumper3 = new Bumper(300, 200, 16, world, Matter);
...
// Ramps
const rampLeft = new Ramp(60, 250, 100, 16, Math.PI / 6, '#BBDEB2', world, Matter);
const rampRight = new Ramp(340, 250, 100, 16, -Math.PI / 6, '#BBDEB2', world, Matter);
