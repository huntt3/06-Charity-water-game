// level7.js - Procedurally generated pinball level
...
// Bumpers
const bumper1 = new Bumper(120, 200, 16, world, Matter);
bumper1.body.restitution = 1.2;
const bumper2 = new Bumper(200, 120, 16, world, Matter);
bumper2.body.restitution = 1.2;
const bumper3 = new Bumper(280, 200, 16, world, Matter);
...
// Ramps
const rampLeft = new Ramp(60, 250, 100, 16, Math.PI / 7, '#BBDEB2', world, Matter);
const rampRight = new Ramp(340, 250, 100, 16, -Math.PI / 7, '#BBDEB2', world, Matter);
