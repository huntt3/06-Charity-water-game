// level8.js - Procedurally generated pinball level
...
// Water can (goal)
const waterCanObj = new WaterCan(360, 340, 40, 40, world, Matter);
...
// Bumpers
const bumper1 = new Bumper(100, 100, 16, world, Matter);
bumper1.body.restitution = 1.2;
const bumper2 = new Bumper(200, 300, 16, world, Matter);
bumper2.body.restitution = 1.2;
const bumper3 = new Bumper(300, 100, 16, world, Matter);
...
// Ramps
const rampLeft = new Ramp(60, 250, 100, 16, Math.PI / 8, '#BBDEB2', world, Matter);
const rampRight = new Ramp(340, 250, 100, 16, -Math.PI / 8, '#BBDEB2', world, Matter);
