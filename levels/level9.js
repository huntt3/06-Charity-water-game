// level9.js - Procedurally generated pinball level
...
// Water can (goal)
const waterCanObj = new WaterCan(200, 340, 40, 40, world, Matter);
...
// Ramps
const rampLeft = new Ramp(60, 250, 100, 16, Math.PI / 9, '#BBDEB2', world, Matter);
const rampRight = new Ramp(340, 250, 100, 16, -Math.PI / 9, '#BBDEB2', world, Matter);
