// level5.js - Procedurally generated pinball level
...
// Water can (goal)
const waterCanObj = new WaterCan(60, 60, 40, 40, world, Matter);
const waterCan = waterCanObj.body;

// Plunger in bottom right
const plunger = new Plunger(360, 370, 16, 48, world, Matter, ball);
...
const bumper2 = new Bumper(200, 100, 16, world, Matter);
...
// Ramps
const rampLeft = new Ramp(60, 250, 100, 16, Math.PI / 5, '#BBDEB2', world, Matter);
const rampRight = new Ramp(340, 250, 100, 16, -Math.PI / 5, '#BBDEB2', world, Matter);
